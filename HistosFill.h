...
#include "CondFormats/JetMETObjects/interface/JetResolutionObject.h" // JER SF
#include "CondFormats/JetMETObjects/interface/JetResolution.h"       // JER SF
...
public:
  ...
  { // Return value between 0 and phi.
...
private:
  ...
  TLorentzVector p4, gp4, genp4, _j1, _j2, _j1_gen, _j2_gen, _j1Up, _j1Down, _j2Up, _j2Down;
  jec::IOV _iov;
